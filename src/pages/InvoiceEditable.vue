<template>
  <VCard >
    ...
    <VDivider />
    <!-- <VForm> -->
    <VCardText class="gap-y-5 " style="padding: 0;">
      <div class="ma-sm-4">
          ...
          <VRow>
            ...
            <VCol cols="10">
              <VRow no-gutters>
                ...
                <!-- <VCol>
                <AppTextField v-model="recipient" density="compact" class="elevation-0">
                  <template #prepend-inner>
                    <div class="text-sm text-disabled" style="width: 60px;">接收者：</div>
                  </template>
                </AppTextField>
              </VCol> -->
              </VRow>
